...
$(".themeBlue").click(() => {
  if (
    $(".outgoing").hasClass("themeDefault") ||
    $(".outgoing").hasClass("themeBlackOutActive")
  ) {
...
$(".themeBlack").click(() => {
  if (
    $(".outgoing").hasClass("themeDefault") ||
    $(".outgoing").hasClass("themeBlueOutActive")
  ) {
...
$(document).click((event) => {
  if (
    !$(event.target).is(
      ".themeSection, .logoImg, .SelectThemeHeading, .FullScreenHeading"
    )
  ) {
...
reqFullscreen =
  FullScrElement.requestFullscreen ||
  FullScrElement.webkitRequestFullScreen ||
  FullScrElement.mozRequestFullScreen ||
  FullScrElement.msRequestFullScreen;
